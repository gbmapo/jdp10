 ...
 *   https://datatables.net/download/#dt/moment-2.29.4/dt-2.3.6/fh-4.0.5/r-3.0.7
 *
 * Included libraries:
 *   Moment 2.29.4, DataTables 2.3.6, FixedHeader 4.0.5, Responsive 3.0.7
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/moment-2.29.4/dt-2.3.6/fh-4.0.5/r-3.0.7",
